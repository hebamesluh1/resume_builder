...
const Resume = forwardRef((props, ref) => {
    ...
    const sectionDiv = {
        [sections.workExp]: (
            <div
                ...
                className={`sectionView ${info.workExp?.sectionTitle ? "" : "hidden"
                    }`}
            >
        ...
        [sections.project]: (
            <div
                ...
                className={`sectionView ${info.project?.sectionTitle ? "" : "hidden"
                    }`}
            >
        ...
        [sections.education]: (
            <div
                ...
                className={`sectionView${info.education?.sectionTitle ? "" : "hidden"
                    }`}
            >
        ...
        [sections.achievement]: (
            <div
                ...
                className={`sectionView ${info.achievement?.sectionTitle ? "" : "hidden"
                    }`}
            >
                <div className="sectionTitle">
        ...
        [sections.summary]: (
            <div
                ...
                className={`sectionView${info.summary?.sectionTitle ? "" : hidden
                    }`}
            >
        ...
        [sections.other]: (
            <div
                ...
                className={`sectionView ${info.other?.sectionTitle ? "" : "hidden"
                    }`}
            >
    ...
    return (
        <div ref={ref}>
            <div ref={containerRef} className="container-resume">
